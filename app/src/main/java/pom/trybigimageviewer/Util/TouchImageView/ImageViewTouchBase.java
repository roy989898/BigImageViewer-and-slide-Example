...
public class ImageViewTouchBase extends ImageView implements IDisposable {
    private final String TAG = "ImageViewTouchBase";
    ...
    protected void panBy(float dx, float dy) {
        ...
        float i = srect.left;
        // if(i==0.0){
        // Log.i(TAG,"srect left=" + srect.left);
        // ImageViewTouch.setTouchFlag(true);
        // }
        // else{
        // ImageViewTouch.setTouchFlag(false);
        // }
        // center( true, true );
    }
